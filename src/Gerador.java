...
public class Gerador {
	...
	static String[] categorias = {"Arte","Banda Desenhada","Ciências Exatas e Naturais","Ciências Socias e Humanas","Desenvolvimento Pessoal e Espititulal",
								"Desporto e Lazer","Dicionários e Enciclopédias","Direito","Economia,Finanças e Contabiblidade","Engenharia","Ensino e Educação",
								"Gastronomia e Vinhos","Gestão","Guias Turísticos e Mapas","História","Infantis e Juvenis","Informática","Literatura",
								"Medicina","Plítica","Religão e Moral","Saude e Bem Estar","Plano Nacional de Leitura","Vida Prática"};
